...
Read on: [Why Nimiq Pay](./why-nimiq-pay.md) for the wallet features this depends on, and
[Trust model](./trust-model.md) for what counts as a stamp and what Vango will never do.
