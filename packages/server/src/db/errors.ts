...
/**
 * Which unique index refused the write, so a caller can tell "someone already holds this
 * reward" from "that six digit code is taken, try another one". PGlite names the index in
